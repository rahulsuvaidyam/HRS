...
const Text: FC<TextProps> = ({name,label,disabled=false}) => {
    return (
        <>
            <div className="relative z-0 w-full mb-4 group">
                <Field disabled={disabled} type="text" name={name} id={name}
                    className={`block py-1.5 px-0 w-full text-sm font-medium
