    ...
    {products?.length >= 1 ?
      <div className="pt-12 md:pt-14 pb-16 overflow-y-auto scrollbar-thin w-full h-full px-0 md:px-8 bg-gray-100 relative" >
        <div className="w-full gap-2 md:pt-3 grid grid-cols-1 xl:grid-cols-2 ">
          {products?.map((e: any) => (
            <div className=" h-36 md:h-40 p-2 text-gray-800 bg-white border flex flex-col md:flex-row justify-between">
              ...
              <div className="flex flex-row-reverse md:flex-col items-center justify-between">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <div className="flex bg-gray-100 px-2 py-1 rounded-md">
                    ...
                    <select name="" id="" onChange={(el) => CartItemCount(e?._id, el.target.value)} className='outline-none'>
                      <option selected={e?.count === 1} value="1">1</option>
                      <option selected={e?.count === 2} value="2">2</option>
                      <option selected={e?.count === 3} value="3">3</option>
                    </select>
                  </div>
                </div>
              </div>
